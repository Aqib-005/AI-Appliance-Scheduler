...
# Clean column names in weather data
...
# Load and clean historical datasets
...
# Filter each dataset by the historical date range
...
# Sort by datetime and fill missing values
merged_data.sort_values('Start Date/Time', inplace=True)
merged_data.ffill(inplace=True)

# Save merged historical dataset to CSV
...
# Save merged future dataset to CSV
