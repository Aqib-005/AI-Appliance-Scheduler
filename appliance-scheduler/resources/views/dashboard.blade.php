...
<head>
    ...
    <style>
        :root {
            ...
            /* col‑width is shared by all days */
...
<body>
    ...
    <div class="container">
        <div class="left">
            ...
            <div class="timetable-wrapper" id="timetableContainer">
                ...
                {{-- PREP: Group schedule by day and sort --}}
                @php
                    $byDay = [];
                    foreach ($schedule as $e) {
                        $byDay[$e->day][] = $e;
                    }
                    foreach ($byDay as &$dayList) {
                        usort($dayList, fn($a, $b) => $a->start_hour <=> $b->start_hour);
                    }
                @endphp
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            c.scrollTop = rowH * now - c.clientHeight / 2;
